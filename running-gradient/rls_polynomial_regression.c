...
void add_data_point_to_regression(
    ...
    if (regression_state->current_num_points >= regression_state->max_num_points) {
        ...
        double old_x_value = (double)(regression_state->total_data_points_added 
                                      - regression_state->max_num_points);
...
static void recompute_qr_decomposition(
    ...
    for (int i = 0; i < num_data_points; ++i) {
        ...
        double x = (double)(regression_state->total_data_points_added 
                            - num_data_points + i);
    ...
    for (int k = 0; k < num_coefficients; ++k) {
        ...
        double vk = augmented_matrix_A[k][k] 
                  + (augmented_matrix_A[k][k] >= 0.0 ? sigma : -sigma);
